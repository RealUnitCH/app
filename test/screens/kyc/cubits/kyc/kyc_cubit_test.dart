...
void main() {
  ...
  KycCubit buildCubit() => KycCubit(kycService, registrationService, walletService);
  ...
  group('$KycCubit timeout & generation handling', () {
    test(
      ...
      () async {
        ...
        final cubit = KycCubit(kycService, registrationService, walletService)
