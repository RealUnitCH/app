...
- Wallet-Daten werden verschlüsselt in einer lokalen Datenbank gespeichert.
- Einstellungen (Sprache, Währung, Netzwerk) werden lokal gespeichert.
- Die PIN wird als kryptografischer Hash gespeichert, nicht im Klartext.
...
Die App wird «wie besehen» («as is») zur Verfügung gestellt. RealUnit übernimmt keine Gewährleistung für:

- Die ununterbrochene oder fehlerfreie Funktionsweise der App
- Die Richtigkeit, Vollständigkeit oder Aktualität der angezeigten Kursdaten und Guthaben
- Schäden oder Verluste, die durch technische Störungen, Software-Fehler oder Sicherheitslücken entstehen
