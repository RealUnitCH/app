...
class RealUnitSellPaymentInfoService extends DFXAuthService {
  ...
  static String _unsignedTxsPath(int id) =>
      '/v1/realunit/sell/$id/unsigned-transactions';
  ...
  Future<SellPaymentInfo> getPaymentInfo(
    ...
    if (response.statusCode == 200) {
      ...
      return SellPaymentInfo(
        ...
        ethereumTransactionFeeChf: responseDto.ethereumTransactionFeeChf,
        ethereumTransactionFeeRealu: responseDto.ethereumTransactionFeeRealu,
  ...
  Future<RealUnitUnsignedTransactionsRequestDto> createUnsignedTransactions(
    int id,
  ) async {
  ...
  Future<void> confirmPaymentWithTxHash(
  ...
  Future<void> _sendConfirm(int id, RealUnitSellConfirmDto dto) async {
    ...
    if (response.statusCode != 200 && response.statusCode != 201) {
      ...
      if (error.statusCode == 409 &&
          error.message.toLowerCase().contains('already confirmed')) {
